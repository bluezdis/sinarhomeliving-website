            ...
            <div className="lg:col-span-3">
              <div className="sticky top-24">
                ...
                <p className="text-muted mb-6">
                  Lihat dan rasakan langsung kualitas produk kami
                </p>
                ...
                <Card className="overflow-hidden p-0">
                  <div className="aspect-[4/3] bg-secondary flex items-center justify-center relative">
                    ...
                    <div className="relative text-center space-y-4 p-8">
                      ...
                      <div>
                        <p className="text-foreground font-semibold mb-1">Google Maps</p>
                        <p className="text-muted text-sm">Peta lokasi akan ditampilkan di sini</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-secondary/30 border-t border-border">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-sm text-foreground">
                        Jl. Raya Furniture No. 123, Jakarta Selatan 12345
                      </p>
                    </div>
                  </div>
                </Card>
